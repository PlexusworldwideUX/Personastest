// VERSION 3 - CHECKPOINT: Blue FAB strips HTML (bold/italic/underline not preserved in dialog)
// Current state: EditableText supports Cmd-B/I/U formatting, but Blue FAB dialog strips all HTML tags via stripHtml() before displaying
...
export default function App() {
  ...
  return (
    <div className="size-full flex items-start justify-center overflow-auto bg-[rgb(255,255,255)] py-8">
      ...
      <div
        className="bg-white relative rounded-[36px] w-[1554px] min-h-[1656px] shadow-2xl"
                ...
                <div className="shrink-0">
                  <Frame73 
                    ...
                    onRankChange={(newRank) => {
                      setPersonaData(prev => ({
                        ...prev,
                        ambassadorRank: newRank
                      }));
                    }}
                    onVIPStatusChange={(newStatus) => {
                      setPersonaData(prev => ({
                        ...prev,
                        previousVIPStatus: newStatus
                      }));
                    }}
                    onBusinessInterestChange={(newInterest) => {
                      setPersonaData(prev => ({
                        ...prev,
                        potentialBusinessInterest: newInterest
                      }));
                    }}
                    onRevenueChange={(newRevenue) => {
                      setPersonaData(prev => ({
                        ...prev,
                        revenueOpportunity: newRevenue
                      }));
                    }}
                  />
                </div>
            ...
            <div className="content-stretch flex gap-[66px] items-start relative shrink-0">
              ...
              <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-[445px]">
                ...
                <div className="content-stretch flex flex-col gap-[20px] items-start overflow-visible relative shrink-0 w-full">
                  ...
                  >Experience Expectations<span className="font-['Avenir:Roman',_sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[rgba(17,17,17,0)] text-[22px]">Surveys</span>
                  </SectionTitle>
                  <Slider 
                    type="CSAT"
