// VERSION 360 - CustomerTypeSelector with disabled and grayed out button
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button
          className="fixed top-8 right-8 z-50 rounded-full w-14 h-14 shadow-lg bg-gray-400 hover:bg-gray-400 text-gray-200 cursor-not-allowed opacity-60"
