...
export function GeminiChat({
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {isExpanded && (
        <div className="fixed bottom-24 right-6 w-96 bg-white rounded-lg shadow-2xl border border-gray-200 p-4 z-50">{/* changed from bottom-6 to bottom-24 to sit above snackbar */}
