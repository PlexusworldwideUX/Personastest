...
const BASE_INSTRUCTIONS_TEMPLATE = `Analyze any attached document and use data in attached document to override any existing instruction or data below. and then understand all data to generate a response to the "Prompt".
Instructions: 
•	"Overrides" – {OVERRIDES}
...
•   Do not refer to Persona in any field
•  Do not use persona name in any field except for Name.
•  Do not use personality acronym in any field. Only use "personality type". Example, if “ISFJ” then only use “Defends Purpose”.
•	"MLM Sentiment" – Use “Age” to research, analyze, and understand the common feelings toward the multi-level marketing business style. Demographic Insight
Purpose: These insights provide direct impact on the “Behavioral Insight” category. 
"Age Demographics"- use the “Age Generation” that the “age” falls within. 
“Age Generation”- “Boomers”, “GenX”, “Millennials”, “Gen Z”
"Generation range" - Research, analyze, and understand the age ranges for each group in “Age Generation”
“Age”- identify the “Generation range” and pick one number within that range. Then, update “age” in code.
...
“Gender” – always female unless provided with an override. Then, update “Gender” in code.
...
“Generation Income”- Research, analyze, and understand the most popular occupations for each “Age Generation” an associate the most common salary of the occupation.
“Income” – use “Generation Income” result. Then, update “Income” in code.
...
"Education Level" – use the “Age Generation” data and research, analyze, and understand average education levels of each demographic. Include, subject of study most commonly achieved in degree. 
“Education”- use "Education Level" result. And then update “education” in code.
...
"Location" - Research, analyze, and understand rural locations of where the average and most common MLM entrepreneur lives across the United States of America, randomly pick one, and specify a specific City, State. Then, update “location” in code.
“Location Tool Tip”- use “Location”, “behavioral sentiment”,  and “Personality Sentiment” to create a short sentence that associates “Location” to “MLM Sentiment”, then update “locationTooltip” in code.
“Generation Occupation” – Research, analyze, and understand the most popular occupations for each “Age Generation”
“Occupation” – use a selection from “Generation Occupation”. Then, update “occupation” in code.
...
“Family Generation” - Research, analyze, and understand the most common family size for each “Age Generation”
“Family” – use a number from “Family Generation”. Then, update “family” in code.
“Family Tool Tip”- use “Family Generation”, “behavioral sentiment”,  and “Personality Sentiment” to create a short sentence that associates “Family Generation” to “MLM Sentiment”, then update “familyTooltip” in code.
“Spouse Occupation” – Research, analyze, and understand common employment titles of the husbands who have entrepreneurial wives. Then, update “spouseOccupation” in code.
...
"Consumer Habits" – use "Age Demographics" to research, analyze, and understand each demographic’s online consumer and purchase habits of supplements across health and wellness companies using an MLM or affiliate marketing strategy. 
"Technical Aptitude" – use "Age Demographics" to research, analyze, and understand the average understanding of technology that each demographic is commonly capable of interacting with proficiently. 
"Brands"- use “Age”, “gender”, “Income” to research and analyze commonly purchased brands across apparels, supplements, fitness education, shopping stores to generate a list of each one.
"Favorite brands"- select 1 unique brand from each category in “Brands”. Then, update “brand_1”, “brand_2”, “brand_3”, and “brand_4” in code. 
“Platforms”- use “Age”, “gender”, “Income” to research and analyze commonly utilized communication platforms of mass communication.
"Favorite Platforms”- create a list of 4 platforms from “Platforms”. Then update “platform_1”, “platform_2”, “platform_3”, and “platform_4” in code.
“Behavioral insight”
...
“Personality Type”- Use the “Score Based Trait Conversion” acronym and ascribe one of the following titles, and then update the “personalityType” field in code, do not include any acronym in parentheses.
•	 “A Logistician”: (ISTJ)
•	 “A Defender”: (ISFJ)
•	 “A Virtuoso”: (ISTP)
•	 “An Advnturer”: (ISFP)
...
“Characteristics” – use “About” to define a list of 4 unique features and qualities. Then, in code under “characteristics”, update the 4 “N/A” fields
Personality Sliders
...
“Goals” – use the personality sliders sentiment sentences and the “Behavioral Insights” and create 4 goals that attain the “consumer wants”. Then, in code under “lists goals:”, update the 4 “N/A” fields.
“Needs” - use the personality sliders sentiment sentences from the highest pointed sliders and create 4 needs that will help achieve “Goals” listed from “goals”. Then, in code under “lists needs:”, update the 4 “N/A” fields.
“Pain Points” - use the personality sliders sentiment sentences and create 4 separate sentences that would be problematic to achieving the “goals” listed, and the “needs” listed. Then, in code under “lists painPoints:”, update the 4 “N/A” fields.
...
•	“High” - $1,302.00
“Income Based Business Interest” – analyze attached document in section title “AGE, GENDER AND INCOME RELATED PERCEPTIONS OF DIRECT SELLING”
“Entrepreneurial Interest”- use “Household Income”
 And “Income Based Business Interest” to select an option below and update “potentialBusinessInterest” in code one of the following
•	“Low” – Not Likely
...
“revenueTooltip”- use “Minimum Reward sentiment”
“Desired 30 day income”- Use “income” to choose the correct value from “Required Minimum First Return” then update “revenueOpportunity” in code.
“timeTooltip” – use “Entrepreneur Sentiment”
Encouragement 
...
For all tooltips in customer experience survey, use “Nurture Style” writing style.
"Survey Sentiment" - use “Behavioral Sentiment”, “Personality sentiments”, “Motivational Drivers”, and “Entrepreneurial Behavior”,  to create a model of expectations and needs for persona for how “customer Experience Survey” questions are answered.
...
“CSAT Sentiment” – Analyze all the answers from CSAT scores and create a description of their needs and expectations in how they answered. Then, update “csatTooltip” in code
...
“CES Sentiment” – Analyze all the answers from CES scores and create a description of their needs and expectations in how they answered. Then, update “cesTooltip” in code.
...
“NPS Sentiment” – Analyze all the answers from NPS scores and create a description of their needs and expectations in how they answered. Then, update “npsTooltip” in code.
“cxRequirementsTooltip”- use “NPS Sentiment”, “CES Sentiment”, and “CSTAT Sentiment” to build a summary paragraph of no more than 300 text characters including punctuation that explains expectations for digital interactions. Then update cxRequirementsTooltip in code.
...
“Entrepreneurial Interest” – From section in attached document “AGE, GENDER AND INCOME RELATED PERCEPTIONS OF DIRECT SELLING”

Brand awareness 
Purpose: to understand the persona’s level of awareness to the Plexus Brand and ascribe one of the following choices based on the persona’s exposure level. If the user's Age group is "Gen Z" or "Millennial", select the "Self-Discovery" or "Through my network" Exposure Level.  If the user's Age group is "Gen X" or "Boomer", select the "Self-Discovery" or "Through AMbassador" Exposure Level.“exposure tool” -use a random number generator of 1-3 to select one  “exposure level” to then generate a sentence that incorporates the level. Example: if “1 = “Self-Discovery” then the sentence could be “Persona discovered Plexus organically through searching for supplements online.” And then update “vipTooltip” in code
“exposure Level” – 3 ways to how the persona discovered Plexus
-	1=“Self-Discovery”- organically became aware of Plexus through self driven health curiosities
-	2=“Through my network”- received notification or saw a social post or heard through word by mouth.
-	3=“Through Ambassador” – direct communication from and existing Plexus 
“Brand Awareness Path”- use exposure level to then update “previousVIPStatus” in code. Example: if exposure level =1 then “Brand Awareness Path” is “Self-Discovery”
Ambassador
Starting Potential
Purpose: to identify a plausible start of engagement from the persona when they first complete a purchase.
“Potential Sentiment”- Use choice from “Entrepreneurial Interest”, associated data from “Income Based Business Interest”, “Personality Type”, “Entrepreneur Sentiment”, to build a one sentence summary that correlates to “exposure Level”. Example: if “exposure Level” is 3. “Through Ambassador”  then  the senctence could be “The persona is an “Explorer”, and with her household income and discovery of Plexus through an ambassador, she is potentially likely to start as an ambassador” then update “ambassadorRankTooltip” in code
Nurture of persona 
Purpose: provide a paragraph that explicitly details a set of actions that can support the user in becoming a Plexus customer or direct selling business owner.
“nurture Sentiment”-  using the “personality type”, "MLM sentiment", “Plexus Tools”, and the following sections in the attached document: "AGE, GENDER AND INCOME RELATED PERCEPTIONS OF DIRECT SELLING", "RETENTION" and "CHURN" to understand how to respond to persona in an encouraging way.
...
“Brand Awareness”- downloadable Plexus content like PDFs, web landing pages, and videos that cover Plexus Brand Identity “Product Toolkits”- printable Plexus content like PDFs that cover product specific information “Educational Calls”- Plexus group calls that focus on “Power hour”, “Master Class”, “Plex-a-Thon”, “Monthly Training” “Testimonials”- Plexus webpage to view and submit product or experience testimonials. 
“Nurture Text” – Use “nurture Sentiment”, and “Encouragement Sentiment” to write a paragraph between 400 to 500 characters including punctuation that quickly explain how to achieve “Goals” and work with “pain points. Use the “Nurture Style” to write the paragraph. Then update “nurtureText” in code.
About Section
"Name" – Generate a random female name with no more than 9 characters that is not gender neutral like "chris" or "Pat". Then, update the “name” in code.
"Tagline" – Use “About” and “Personality Type” to create a short descriptor of the persona. It is not a quote, and can not be more than 26 characters long. Then, update “tagline” in code
...
"Quote" – Use “About” to generate a one-line saying that the persona would actually speak. Then, update “quote” in code.
“Quote Note” – Use “Quote” and “About”  to write less than 100 characters including punctuation, an action that the persona would actually do. Example: “While scheduling my gig work in the little free time I have between dropping of and pick up kids, along with everything else I have to do.” Then, update “quoteNote” in code
...
“about style” - use the writing style of author Dr. Mark Hyman in the first person point of view.
“Nurture Style”- use the writing style of gentle authority from the third person point of view. 
